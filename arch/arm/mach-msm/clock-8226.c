...
static struct clk_freq_tbl ftbl_gcc_blsp1_qup1_6_spi_apps_clk[] = {
	...
	F_GCC(    600000,         xo,   8,   1,   4),
	F_GCC(    800000,         xo,  12,   1,   2),
#endif	/* #if defined( CONFIG_SHTPS_SY3X00_DEV ) */
	F_GCC(    960000,         xo,  10,    1,    2),
#if defined( CONFIG_SHTPS_SY3X00_DEV )
	F_GCC(   1100000,      gpll0,   5,    1,  109),
	F_GCC(   1920000,         xo,  10,    1,    0),
	F_GCC(   2000000,      gpll0,  10,    1,   30),
	F_GCC(   2400000,         xo,   8,    1,    0),
	F_GCC(   3000000,      gpll0,  10,    1,   20),
	F_GCC(   3200000,         xo,   2,    1,    3),
	F_GCC(   3400000,      gpll0,   8,    1,   22),
	F_GCC(   3750000,      gpll0,  10,    1,   16),
	F_GCC(   4000000,      gpll0,  10,    1,   15),
#endif	/* #if defined( CONFIG_SHTPS_SY3X00_DEV ) */
...
#if (defined(CONFIG_SND_SOC_ES_UART) || defined(CONFIG_SND_SOC_ES_HIGH_BW_BUS_UART))
	F_GCC(  16384000,      gpll0,  15,  256,   625),
#endif	/* (defined(CONFIG_SND_SOC_ES_UART) || defined(CONFIG_SND_SOC_ES_HIGH_BW_BUS_UART)) */
/* <= SH_AUDIO_DRIVER 15-061 */
	F_GCC(  19200000,         xo,   1,    0,    0),
...
/* => SH_AUDIO_DRIVER 15-061 */
#if (defined(CONFIG_SND_SOC_ES_UART) || defined(CONFIG_SND_SOC_ES_HIGH_BW_BUS_UART))
	F_GCC(  32768000,      gpll0,    1,  512, 9375),
#endif	/* (defined(CONFIG_SND_SOC_ES_UART) || defined(CONFIG_SND_SOC_ES_HIGH_BW_BUS_UART)) */
/* <= SH_AUDIO_DRIVER 15-061 */
...
static struct clk_freq_tbl ftbl_camss_gp0_1_clk[] = {
	...
	F_MMSS(  10526315,      gpll0,   1,    1,   57),
#endif
	F_MMSS(  12000000,      gpll0,  10,    1,    5),
	F_MMSS(  13000000,      gpll0,   4,   13,  150),
#if defined(CONFIG_S5K8AAYX) || defined(CONFIG_S5K4H5YB)
	F_MMSS(  16000000,      gpll0,   5,    2,   15),
	F_MMSS( 17000000, mmpll0_pll,   1,   1,  47),
	F_MMSS(  17142857,      gpll0,   1,    1,   35),
#endif /* defined(CONFIG_S5K8AAYX) || defined(CONFIG_S5K4H5YB) */
#ifdef CONFIG_SH_AUDIO_DRIVER /* 15-061 */
	F_MMSS(  19200000,         xo,   1,    0,    0),
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 15-061 */
	F_MMSS(  24000000,      gpll0,   5,    1,    5),
#if defined(CONFIG_SHLCDC_BOARD)
	F_MMSS(  27272727,      gpll0,  11,    1,    2), /* provide 600*1/(11*2)=27.27M clk for lcd*/
#endif
	F_END
};
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 15-061 */
	CLK_LOOKUP("cam_gp0_clk", camss_gp0_clk.c, "es804-codec-gen0"),
	CLK_LOOKUP("cam_gp0_clk", camss_gp0_clk.c, "earSmart-codec-gen0"),
