...
#	dtb-$(CONFIG_ARCH_MSM8226)	+= apq8026-v2-1080p-mtp.dtb
	dtb-$(CONFIG_MACH_PA25)	+= msm8926-sharp-pa25-v1-720p.dtb
	dtb-$(CONFIG_MACH_PA25)	+= msm8926-sharp-pa25-v2-720p-cdp.dtb
	dtb-$(CONFIG_MACH_PA28)	+= msm8926-sharp-pa28-v1-720p.dtb
	dtb-$(CONFIG_MACH_PA28)	+= msm8926-sharp-pa28-v2-720p-cdp.dtb
