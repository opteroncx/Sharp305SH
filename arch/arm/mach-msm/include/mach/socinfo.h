...
#define machine_is_sharp_pa25() of_machine_is_compatible("qcom,sharp-pa25")
#define machine_is_sharp_pa28() of_machine_is_compatible("qcom,sharp-pa28")
...
#define machine_is_sharp_pa25()		0
#define machine_is_sharp_pa28()		0
