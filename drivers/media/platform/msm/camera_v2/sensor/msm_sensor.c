...
//	CDBG("%s rev=0x%0x\n", __func__, rev);
//	if(rev == 0x00){
//		if(s_ctrl->cci_i2c_master == 1){
//			s_ctrl->cci_i2c_master = 0;
//		} else if(s_ctrl->cci_i2c_master == 0){
//			s_ctrl->cci_i2c_master = 1;
//		}
//	}
#endif
/* SHLOCAL_CAMERA_DRIVERS<- */
...
int32_t msm_sensor_platform_shortcut_probe(struct platform_device *pdev, void *data)
{
	int rc = 0;
	struct msm_sensor_ctrl_t *s_ctrl =
		(struct msm_sensor_ctrl_t *)data;
