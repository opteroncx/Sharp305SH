...
int qpnp_bms_get_vbatt_avg(int *result_mV, int *adc_code)
{
	...
	/* COORDINATOR Qualcomm_CPL3 BUILDERR MODIFY start */
	result_uV = convert_vbatt_raw_to_uv(the_chip, *adc_code, 0);
	/* COORDINATOR Qualcomm_CPL3 BUILDERR MODIFY end */
...
#define BMS_STORE_INVALID_CAPACITY			(-1)
