...
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE13         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     ...
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE14         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSREQ_STR      \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE15         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_RECOVNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE16         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSALSNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE17         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_POWERNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE18         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE19         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DISPONCHK_STR  \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE20         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_DISPONCHK_STR  \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE21         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_BDIC_STR          \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_I2CREAD_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE22         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSALSNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE23         (SHDISP_DBG_MODE_NoOS_STR          \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_POWERNG_STR    \
                                                     "   0  \n")
...
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE28         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     ...
                                                     SHDISP_DBG_SUBCODE_ESDDETIN_STR   \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE29         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_ESDMIPI_STR    \
                                                     "   0  \n")
...
#if defined(SHDISP_CLMR_FW_TIMEOUT_DUMP) || defined(SHDISP_RESET_LOG)
...
#endif /* SHDISP_CLMR_FW_TIMEOUT_DUMP || SHDISP_RESET_LOG */
...
#define SHDISP_FWTO_DUMPFILE_MAX_RETRY (10)
...
const static struct shdisp_dbg_error_code ErrorCodeIndex[] = {
   ...
   ,{SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_PANEL,      SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_ESD_MIPI         }
   ,{SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_BDIC,       SHDISP_DBG_CODE_RETRY_OVER,
   ...
   ,{SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_PANEL,      SHDISP_DBG_CODE_READ_ERROR,
                                                                                SHDISP_DBG_SUBCODE_DEVCODE          }
   ,{SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_PANEL,      SHDISP_DBG_CODE_READ_ERROR,
                                                                                SHDISP_DBG_SUBCODE_DISPON_CHK       }
   ,{SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_PANEL,      SHDISP_DBG_CODE_ERROR_DETECT,
                                                                                SHDISP_DBG_SUBCODE_DISPON_CHK       }
   ,{SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_BDIC,       SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_I2C_READ         }
   ,{SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_PSALS,      SHDISP_DBG_CODE_ERROR_DETECT,
                                                                                SHDISP_DBG_SUBCODE_PSALS_ON_NG      }
   ,{SHDISP_DBG_MODE_NoOS,          SHDISP_DBG_TYPE_PSALS,      SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_POWER_ON_NG      }
...
size_t shdisp_dbg_get_stacktrace(char* stackdumpbuf, size_t length)
{
   ...
   SHDISP_TRACE("ptr=0x%p len=%d\n", stackdumpbuf, length);
    ...
    SHDISP_TRACE("dump stuck trace size=%d\n", writelen);
    return writelen;
}

#if defined (CONFIG_ANDROID_ENGINEERING)
/* ------------------------------------------------------------------------- */
/* shdisp_dbg_get_fail_retry_flg                                             */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_dbg_set_recovery_check_error                                       */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_dbg_get_recovery_check_error                                       */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_dbg_update_recovery_check_error                                    */
/* ------------------------------------------------------------------------- */
...
static int shdisp_dbg_summary_init_file(void)
{
    ...
    SHDISP_DEBUG("open file: %s pid=%d tgid=%d comm=%s\n", SHDISP_DBG_DISPLAY_ERROR_FILE, current->pid, current->tgid,
                                                                                                       current->comm);
...
static void shdisp_dbg_reset_work_add_command(struct shdisp_dbg_reset_work_command* cmd)
{
    SHDISP_DEBUG("add queue: proc=%pS arg=%p\n", cmd->proc, cmd->arg);
...
static void shdisp_dbg_reset_work_worker(struct work_struct *wk)
{
    ...
    for (;;) {
        ...
        SHDISP_DEBUG("execute: proc=%pS arg=%p\n", cmd->proc, cmd->arg);
...
static void shdisp_dbg_dispdump_worker(void* arg, int* reset)
{
    ...
    while (1) {
        ...
        if (error == -EEXIST) {
            ...
            SHDISP_ERR("shdisp_dbg_dispdump_check_max_file_number() error[%d] continue\n", error);
            goto retry;
        }
#endif /* SHDISP_CLMR_FWTO_DUMPFILE_DO_RING */
...
retry:
        ...
        SHDISP_WARN("Output FW dumpfile retry(%d)\n", retry_cnt);
        msleep(1000);
    }
