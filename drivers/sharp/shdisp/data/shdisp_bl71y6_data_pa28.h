/* drivers/sharp/shdisp/data/shdisp_bl71y6_data_pa28.h  (Display Driver)
 *
...
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO         (125)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX          (0x18)
#define SHDISP_BKL_PWM_LOWER_LIMIT              (0x0010)
#define SHDISP_BKL_PWM_OPT0_LOWER_LIMIT         (0x0010)
#define SHDISP_BKL_PWM_OPT1_23_LOWER_LIMIT      (0x006F)
...
#define BDIC_REG_OPT6_HT_L_VAL                  (0x25)
#define BDIC_REG_OPT6_HT_H_VAL                  (0x01)
#define BDIC_REG_OPT7_LT_L_VAL                  (0xFB)
#define BDIC_REG_OPT7_LT_H_VAL                  (0x00)
#define BDIC_REG_OPT7_HT_L_VAL                  (0xA5)
#define BDIC_REG_OPT7_HT_H_VAL                  (0x01)
#define BDIC_REG_OPT8_LT_L_VAL                  (0x7B)
#define BDIC_REG_OPT8_LT_H_VAL                  (0x01)
#define BDIC_REG_OPT8_HT_L_VAL                  (0x7B)
#define BDIC_REG_OPT8_HT_H_VAL                  (0x02)
#define BDIC_REG_OPT9_LT_L_VAL                  (0x25)
#define BDIC_REG_OPT9_LT_H_VAL                  (0x02)
#define BDIC_REG_OPT9_HT_L_VAL                  (0x3B)
#define BDIC_REG_OPT9_HT_H_VAL                  (0x04)
#define BDIC_REG_OPT10_LT_L_VAL                 (0x85)
#define BDIC_REG_OPT10_LT_H_VAL                 (0x03)
#define BDIC_REG_OPT10_HT_L_VAL                 (0x65)
#define BDIC_REG_OPT10_HT_H_VAL                 (0x06)
#define BDIC_REG_OPT11_LT_L_VAL                 (0xAB)
#define BDIC_REG_OPT11_LT_H_VAL                 (0x05)
#define BDIC_REG_OPT11_HT_L_VAL                 (0x6B)
#define BDIC_REG_OPT11_HT_H_VAL                 (0x09)
#define BDIC_REG_OPT12_LT_L_VAL                 (0x45)
#define BDIC_REG_OPT12_LT_H_VAL                 (0x08)
#define BDIC_REG_OPT12_HT_L_VAL                 (0x7B)
#define BDIC_REG_OPT12_HT_H_VAL                 (0x0E)
#define BDIC_REG_OPT13_LT_L_VAL                 (0x85)
#define BDIC_REG_OPT13_LT_H_VAL                 (0x0C)
#define BDIC_REG_OPT13_HT_L_VAL                 (0x85)
#define BDIC_REG_OPT13_HT_H_VAL                 (0x14)
#define BDIC_REG_OPT14_LT_L_VAL                 (0x7B)
#define BDIC_REG_OPT14_LT_H_VAL                 (0x12)
#define BDIC_REG_OPT14_HT_L_VAL                 (0x5B)
#define BDIC_REG_OPT14_HT_H_VAL                 (0x1F)
#define BDIC_REG_OPT15_LT_L_VAL                 (0xF5)
#define BDIC_REG_OPT15_LT_H_VAL                 (0x1A)
#define BDIC_REG_OPT15_HT_L_VAL                 (0xC0)
#define BDIC_REG_OPT15_HT_H_VAL                 (0x32)
#define BDIC_REG_OPT16_LT_L_VAL                 (0x40)
#define BDIC_REG_OPT16_LT_H_VAL                 (0x2B)
#define BDIC_REG_OPT16_HT_L_VAL                 (0x00)
#define BDIC_REG_OPT16_HT_H_VAL                 (0x49)
#define BDIC_REG_OPT17_LT_L_VAL                 (0xA0)
#define BDIC_REG_OPT17_LT_H_VAL                 (0x41)
#define BDIC_REG_OPT17_HT_L_VAL                 (0x20)
#define BDIC_REG_OPT17_HT_H_VAL                 (0x66)
#define BDIC_REG_OPT18_LT_L_VAL                 (0x40)
#define BDIC_REG_OPT18_LT_H_VAL                 (0x5B)
#define BDIC_REG_OPT18_HT_L_VAL                 (0xA0)
#define BDIC_REG_OPT18_HT_H_VAL                 (0x94)
#define BDIC_REG_OPT19_LT_L_VAL                 (0xD0)
#define BDIC_REG_OPT19_LT_H_VAL                 (0x82)
#define BDIC_REG_OPT19_HT_L_VAL                 (0x90)
#define BDIC_REG_OPT19_HT_H_VAL                 (0xC9)
#define BDIC_REG_OPT20_LT_L_VAL                 (0x80)
#define BDIC_REG_OPT20_LT_H_VAL                 (0x0B)
#define BDIC_REG_OPT20_HT_L_VAL                 (0x03)
#define BDIC_REG_OPT20_HT_H_VAL                 (0x12)
#define BDIC_REG_OPT21_LT_L_VAL                 (0xDA)
#define BDIC_REG_OPT21_LT_H_VAL                 (0x0F)
#define BDIC_REG_OPT21_HT_L_VAL                 (0xA0)
#define BDIC_REG_OPT21_HT_H_VAL                 (0x1C)
#define BDIC_REG_OPT22_LT_L_VAL                 (0x66)
#define BDIC_REG_OPT22_LT_H_VAL                 (0x18)
#define BDIC_REG_OPT22_HT_L_VAL                 (0x4F)
#define BDIC_REG_OPT22_HT_H_VAL                 (0x27)
#define BDIC_REG_OPT23_LT_L_VAL                 (0x15)
