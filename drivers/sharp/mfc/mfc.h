...
/* GPIO number */
#define D_PON_GPIO_NO			g_snfc_pon_gpio_no
#define D_RFS_GPIO_NO			(108)
#define D_INT_GPIO_NO			(65)
#define D_INT_POLL_GPIO_NO		D_INT_GPIO_NO
#define D_HSEL_GPIO_NO			(112)
#define D_INTU_GPIO_NO			(62)
#define D_VFEL_GPIO_NO			g_snfc_vfel_gpio_no
#define D_MVDD_GPIO_NO 			(50)
#define D_UART_TX_GPIO_NO		(4)
#define D_UART_RX_GPIO_NO		(5)

extern int g_snfc_vfel_gpio_no;
extern int g_snfc_pon_gpio_no;
