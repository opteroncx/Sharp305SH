 ...
 * function_succ
 */
static ssize_t succ_read(struct file *filp, char __user *buf, size_t len, loff_t *ppos)
{
	char on[2];
...
static __init int snfc_init(void)
{
	...
	g_snfc_vfel_gpio_no = qpnp_pin_map("pm8226-gpio", 6);
