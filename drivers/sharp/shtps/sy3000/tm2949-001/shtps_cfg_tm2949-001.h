...
#if defined(SHTPS_MULTI_FW_ENABLE)
	#include "shtps_fw_tm2949-001.h"
	#include "shtps_fw_tm2949-001_es0.h"
	#include "shtps_fw_tm2949-001_es1.h"
...
#define SHTPS_LGM_SPLIT_TOUCH_COMBINING_ENABLE
	...
	#define SHTPS_FACETOUCH_OFF_DETECT_CHG_REPORTMODE_ENABLE
...
#define SHTPS_DEF_SCAN_FREQ_DYNAMIC_CHANGE_ENABLE
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_LPWG_RX_CLIP_LO,						0xFF);
	SHTPS_PARAM_DEF( SHTPS_LPWG_RX_CLIP_HI,						0xFF);
 ...
 */
	...
	SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_CHECK_PALMFLAG,			0);
	...
	SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_PALMDET_W_8BIT_THRESHOLD,40);
		...
		SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_CHG_REPORTING_MODE_ENABLE,	1);
		SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_REPORTING_MODE,				0x02);
		SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_REPORTING_MODE_DEFAULT,		0x00);
...
//	SHTPS_PARAM_DEF(SHTPS_LOS_MULTI,								0x40);
		...
		#if defined(SHTPS_FACETOUCH_OFF_DETECT_CHATTER_CHK_ENABLE)
			SHTPS_PARAM_DEF( SHTPS_FACETOUCH_OFF_DETECT_CHATT_THRESH_TIME, 			300);
			#if defined( SHTPS_LOG_DEBUG_ENABLE )
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_WAKEUP_CALIB_ENABLE_SWITCH,			1);
	...
	SHTPS_PARAM_DEF( SHTPS_WAKEUP_CALIB_LAST_ONE_DELAY_MS,		500);
	SHTPS_PARAM_DEF( SHTPS_WAKEUP_CALIB_STOP_COND_EVENT_NUM,	0);
	SHTPS_PARAM_DEF( SHTPS_WAKEUP_CALIB_STOP_COND_MOVE_DIST,	100);
	SHTPS_PARAM_DEF( SHTPS_WAKEUP_CALIB_STOP_COND_REZERO_EXEC_NUM,	10);
	SHTPS_PARAM_DEF( SHTPS_WAKEUP_CALIB_ONLY_LO_DETECTED,		1);
 ...
 */
	...
	#define SHTPS_SCAN_FREQ_ADDRESS_OFFSET (0x11)
	SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_CHANGE_ENABLE,				1);
	SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_CHANGE_COUNT,				3);
	SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_CHANGE_INTERVAL_THRESH,	50);
	SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_TU_TIMEOUT,				2000);
	SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_1ST_FREQ_INDEX,			0);
	SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_2ND_FREQ_INDEX,			7);

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		SHTPS_PARAM_DEF( SHTPS_SCAN_FREQ_DYNAMIC_CHANGE_LOG_ENABLE,		0);
		#define	SHTPS_LOG_SCAN_FREQ_DYNAMIC_CHANGE(...)						\
			if(SHTPS_SCAN_FREQ_DYNAMIC_CHANGE_LOG_ENABLE != 0){				\
				printk(KERN_DEBUG "[shtps] [scan freq change]" __VA_ARGS__);\
			}
	#else
		#define	SHTPS_LOG_SCAN_FREQ_DYNAMIC_CHANGE(...)
	#endif /* SHTPS_LOG_DEBUG_ENABLE */
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_TOP_OF_SCREEN_GHOST_REJECT_CLEAR_TIME,			100);
	SHTPS_PARAM_DEF( SHTPS_TOP_OF_SCREEN_GHOST_REJECT_Y_THRESH,				250);
	SHTPS_PARAM_DEF( SHTPS_TOP_OF_SCREEN_GHOST_REJECT_Z_THRESH,				130);
	SHTPS_PARAM_DEF( SHTPS_TOP_OF_SCREEN_GHOST_REJECT_XDIFF_THRESH,			100);
	...
	SHTPS_PARAM_DEF( SHTPS_TOP_OF_SCREEN_GHOST_REJECT_BOTTOM_CHECK_ENABLE,		0);
