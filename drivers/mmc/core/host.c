...
#if !defined(CONFIG_RESET_CLK_SCALING_PARAM_EMMC_CUST_SH) || defined(CONFIG_MMC_SD_PENDING_RESUME_CUST_SH)
#include <linux/mmc/mmc.h>
#endif /* !CONFIG_RESET_CLK_SCALING_PARAM_EMMC_CUST_SH || CONFIG_MMC_SD_PENDING_RESUME_CUST_SH */
