...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00018 */ /* CUST_ID_00036 */
#include "mdss_dsi.h"
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00021 */ /* CUST_ID_00039 */
		if (pdata->panel_info.cont_splash_enabled == 0) {
			mdss_shdisp_dsi_panel_post_video_start();
		}
#endif /* CONFIG_SHLCDC_BOARD */
...
void mdss_mdp_video_transfer_ctrl(struct msm_fb_data_type *mfd, bool onoff)
{
