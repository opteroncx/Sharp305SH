...
/* SH_AUDIO_DRIVER-> */ /*10-00x*/
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 501)
	SH_ROUTE_LOOPBACK_PASS_RX1CH_DMIC0,	/* 48 */
#endif /* #if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 501) */
/* <-SH_AUDIO_DRIVER */ /*10-00x*/
	ROUTE_MAX						/* 48 */
};
...
/* SH_AUDIO_DRIVER-> */ /*10-00x*/
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 501)
static const u32 sh_route_loopback_pass_rx1ch_dmic0[] = {
	0xb05a0c00,	/* SetDataPath PDMI0.Rx0 -> RxChMgr0 */
	0xb05a0a01,	/* SetDataPath SBUS.Rx0 -> RxChMgr1 */
	0xb05a0a0a,	/* SetDataPath SBUS.Tx0 -> TxChMgr0 */
	0xb05a0a2b,	/* SetDataPath SBUS.Tx2 -> TxChMgr1 */
	0xb05b000d,	/* SetPathID  RxChMgr0 PASSIN1 */
	0xb05b010e,	/* SetPathID  RxChMgr1 PASSIN2 */
	0xb05b0a2c,	/* SetPathID  TxChMgr0 PASSOUT1 */
	0xb05b0b2d,	/* SetPathID  TxChMgr1 PASSOUT2 */
	0xb0640038,	/* Connect RxChMgr0.o0 */
	0xb0640160,	/* Connect PassThrough.i0 */
	0xb0640048,	/* Connect RxChMgr1.o0 */
	0xb0640161,	/* Connect PassThrough.i1 */
	0xb0640168,	/* Connect PassThrough.o0 */
	0xb06400d0,	/* Connect TxChMgr0.i0 */
	0xb0640169,	/* Connect PassThrough.o1 */
	0xb06400e0,	/* Connect TxChMgr1.i0 */
	0xb0450005,	/* SetMaxExternalPortRate 192k */
	0xb0630303,	/* SetRate RxChMgr0 48k*/
	0xb0630304,	/* SetRate RxChMgr1 48k*/
	0xb0630316,	/* SetRate PassThrough 48k*/
	0xb063030d,	/* SetRate TxChMgr0 48k*/
	0xb063030e,	/* SetRate TxChMgr1 48k*/
	0xb0680300,	/* SetGroup RxChMgr0 0*/
	0xb0680400,	/* SetGroup RxChMgr1 0*/
	0xb0681600,	/* SetGroup PassThrough 0*/
	0xb0680d00,	/* SetGroup TxChMgr0 0*/
	0xb0680e00,	/* SetGroup TxChMgr1 0*/
	0xb00c0900,	/* SetDeviceParmID	Set Multichannel Link bits */
	0xb00d0000,	/* SetDeviceParm	SLIMbus Linked:  <no linked, so clear bits>*/
	0x80000000,
	0xffffffff	/* terminate */
};
#endif /* #if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 501) */
...
/* SH_AUDIO_DRIVER-> */ /*10-00x*/
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 501)
	[SH_ROUTE_LOOPBACK_PASS_RX1CH_DMIC0] = {
		.route = sh_route_loopback_pass_rx1ch_dmic0,
	},
#endif /* #if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 501) */
/* <-SH_AUDIO_DRIVER */ /*10-00x*/
};
