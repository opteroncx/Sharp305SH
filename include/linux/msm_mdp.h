...
#define MSMFB_SPECIFIED_IGC_LUT _IOWR(MSMFB_IOCTL_MAGIC, 172, struct mdp_specified_igc_lut_data)
#define MSMFB_SPECIFIED_ARGC_LUT _IOWR(MSMFB_IOCTL_MAGIC, 173, struct mdp_specified_pgc_lut_data)
