...
#if 1
#define TPSDEV_GET_SERIAL_NUMBER		_IOR ( TPS_IOC_MAGIC, 61, unsigned char*)
#define TPSDEV_GET_SERIAL_NUMBER_SIZE	_IOR ( TPS_IOC_MAGIC, 62, int)
#define TPSDEV_SET_LOW_REPORTRATE_MODE	_IOR ( TPS_IOC_MAGIC, 63, int)
#else
